...
import os
#
#csv file name or absolute path to be opened.
fileToRead = "/Users/ashara/Documents/Study/Research/Dissertation/One Drive/OneDrive - University of Texas at Arlington/Dissertation/data_files/claims_sym_diag_trt_preprocessed.csv"
#name as how you'll save your arff file
fileToWrite = "claims3_attr.arff"
#how you'll like to call your relation as.
relation = "claims_3_attr"
def convert_csv_to_arff(fileToRead, fileToWrite, relation):
	...
	return (fileToWrite + " was converted to " + fileToRead)

convert_csv_to_arff(fileToRead, fileToWrite, relation)